            ...
            holder.crdvwContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!blnPrinter)    {
                        ...
                        /** CHOOSE WHAT THIS PRINTER PRINTS **/
                        new MaterialDialog.Builder(activity)
                                .title("Print what?")
                                .items(R.array.printOptions)
                                .itemsCallbackSingleChoice(0, new MaterialDialog.ListCallbackSingleChoice() {
                                    @Override
                                    public boolean onSelection(MaterialDialog dialog, View itemView, int which, CharSequence text) {
//                                        Toast.makeText(activity, text, Toast.LENGTH_SHORT).show();
//                                        Toast.makeText(activity, String.valueOf(which), Toast.LENGTH_SHORT).show();
                                        ...
                                        if (cursor.getCount() != 0) {
                                            ...
                                            long printerID = dbResto.addPrinter(printerName, printerIP, String.valueOf(which));
