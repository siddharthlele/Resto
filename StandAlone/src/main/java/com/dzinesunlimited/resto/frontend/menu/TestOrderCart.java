...
public class TestOrderCart extends AppCompatActivity implements ReceiveListener {
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new OrderAdapter(TestOrderCart.this, arrOrders);
        ...
        if (bundle.containsKey("TABLE_NO")) {
            ...
            if (INCOMING_TABLE_ID != null)  {
                ...
                db = new DBResto(TestOrderCart.this);
...
//            Log.e("CONNECTION ERROR", e.getMessage().toString());
    ...
    private boolean initializeObject() {
        ...
        mPrinter.setReceiveEventListener(TestOrderCart.this);
    ...
    public void onPtrReceive(final Printer printerObj, final int code, final PrinterStatusInfo status, final String printJobId) {
        runOnUiThread(new Runnable() {
            ...
            public synchronized void run() {
                ShowMsg.showResult(code, makeErrorMessage(status), TestOrderCart.this);
    ...
    private void disconnectPrinter() {
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public synchronized void run() {
                    ShowMsg.showException(e, "endTransaction", TestOrderCart.this);
                }
            });
        }
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public synchronized void run() {
                    ShowMsg.showException(e, "disconnect", TestOrderCart.this);
                }
            });
        }
    ...
    private void configAB() {
        ...
        s.setSpan(new TypefaceSpan(
                TestOrderCart.this, "RobotoCondensed-Regular.ttf"), 0, s.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
...
//                    Log.e("STATUS", String.valueOf(data.isOrderStatus()));
    ...
    private void configRecyclerView() {
        ...
        LinearLayoutManager llm = new LinearLayoutManager(TestOrderCart.this);
    ...
    private void refreshOrderTotal() {
        DBResto resto = new DBResto(TestOrderCart.this);
        String s =
